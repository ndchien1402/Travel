...
<div class="table-agile-info">
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      <form action="{{ URL::to('/search-date')}}" method="post">
        {{ csrf_field()}}
      <div class="col-md-4">
        <div class="input-group">
          <input type="date" name="date_start" class="form-control" placeholder="Search">
        </div>
          <div class="input-group">
          <input type="date" name="date_end" class="form-control" placeholder="Search">
        </div>

...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home($cate_id){
        ...
        $category_by_id = DB::table('tbl_product')->join('tbl_category_product','tbl_product.category_id','=','tbl_category_product.category_id')->where('tbl_category_product.category_id',$cate_id)->paginate(3);
